      ...
      <div className="w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-t-3xl p-5 pb-8 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        {done ? (
          <div className="text-center py-8 space-y-3">
            ...
            <p className="font-black text-white text-lg">Photo submitted!</p>
            <p className="text-sm text-zinc-400">Mr Reyy will review your photo before it appears in Moments.</p>
            <button onClick={onClose} className="mt-2 px-6 py-2.5 bg-purple-600 text-white rounded-xl font-bold text-sm">Close</button>
          </div>
        ) : (
          <div className="space-y-3">
            <div
              className="border-2 border-dashed border-zinc-700 rounded-2xl p-6 flex flex-col items-center gap-2 cursor-pointer hover:border-purple-600 transition-colors"
            ...
            >
              {preview ? (
                ...
                <>
                  ...
                  <p className="text-sm text-zinc-300 font-semibold">Tap to choose a photo</p>
            ...
            >
              {uploading ? <><div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />Uploading...</> : <><Upload size={15} />Submit Photo</>}
            </button>
